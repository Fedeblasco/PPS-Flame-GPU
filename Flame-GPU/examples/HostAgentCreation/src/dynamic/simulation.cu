...
unsigned int count_Agent_default_time_alive_variable(unsigned int count_value){
    //count in default stream
    return (unsigned int)thrust::count(thrust::device_pointer_cast(d_Agents_default->time_alive),  thrust::device_pointer_cast(d_Agents_default->time_alive) + h_xmachine_memory_Agent_default_count, count_value);
}
...
unsigned int count_Agent_s2_id_variable(unsigned int count_value){
    //count in default stream
    return (unsigned int)thrust::count(thrust::device_pointer_cast(d_Agents_s2->id),  thrust::device_pointer_cast(d_Agents_s2->id) + h_xmachine_memory_Agent_s2_count, count_value);
}
...
unsigned int count_Agent_s2_time_alive_variable(unsigned int count_value){
    //count in default stream
    return (unsigned int)thrust::count(thrust::device_pointer_cast(d_Agents_s2->time_alive),  thrust::device_pointer_cast(d_Agents_s2->time_alive) + h_xmachine_memory_Agent_s2_count, count_value);
}
