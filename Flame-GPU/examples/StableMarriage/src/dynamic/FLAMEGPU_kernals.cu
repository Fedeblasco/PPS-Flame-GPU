...
////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Dynamically created Man agent functions */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Dynamically created Woman agent functions */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Dynamically created proposal message functions */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Dynamically created notification message functions */
...
__global__ void GPUFLAME_check_proposals(xmachine_memory_Woman_list* agents, xmachine_message_proposal_list* proposal_messages){
	...
	agent.id = 0;
	agent.current_suitor = 0;
	agent.current_suitor_rank = 0;
    agent.preferred_man = nullptr;
	}
