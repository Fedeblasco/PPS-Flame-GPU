	...
	while(reading==1)
	{
		...
		else if(c == '<')
		{
			...
			else if (in_xagent)
			{
				...
				if(in_Circle_x){
                    Circle_x = (double) fpgu_strtod(buffer); 
                }
				if(in_Circle_y){
                    Circle_y = (double) fpgu_strtod(buffer); 
                }
				if(in_Circle_z){
                    Circle_z = (double) fpgu_strtod(buffer); 
                }
				if(in_Circle_fx){
                    Circle_fx = (double) fpgu_strtod(buffer); 
                }
				if(in_Circle_fy){
                    Circle_fy = (double) fpgu_strtod(buffer); 
                }
