...
void runConsoleWithXMLOutput(int iterations, int outputFrequency){
	...
	for (int i=0; i< iterations; i++)
	{
		...
		if((i+1) % outputFrequency == 0){
			saveIterationData(outputpath, i+1, get_host_agent_default_agents(), get_device_agent_default_agents(), get_agent_agent_default_count(),get_host_navmap_static_agents(), get_device_navmap_static_agents(), get_agent_navmap_static_count(),get_host_chair_defaultChair_agents(), get_device_chair_defaultChair_agents(), get_agent_chair_defaultChair_count(),get_host_bed_defaultBed_agents(), get_device_bed_defaultBed_agents(), get_agent_bed_defaultBed_count(),get_host_doctor_manager_defaultDoctorManager_agents(), get_device_doctor_manager_defaultDoctorManager_agents(), get_agent_doctor_manager_defaultDoctorManager_count(),get_host_specialist_manager_defaultSpecialistManager_agents(), get_device_specialist_manager_defaultSpecialistManager_agents(), get_agent_specialist_manager_defaultSpecialistManager_count(),get_host_specialist_defaultSpecialist_agents(), get_device_specialist_defaultSpecialist_agents(), get_agent_specialist_defaultSpecialist_count(),get_host_receptionist_defaultReceptionist_agents(), get_device_receptionist_defaultReceptionist_agents(), get_agent_receptionist_defaultReceptionist_count(),get_host_agent_generator_defaultGenerator_agents(), get_device_agent_generator_defaultGenerator_agents(), get_agent_agent_generator_defaultGenerator_count(),get_host_chair_admin_defaultAdmin_agents(), get_device_chair_admin_defaultAdmin_agents(), get_agent_chair_admin_defaultAdmin_count(),get_host_uci_defaultUci_agents(), get_device_uci_defaultUci_agents(), get_agent_uci_defaultUci_count(),get_host_box_defaultBox_agents(), get_device_box_defaultBox_agents(), get_agent_box_defaultBox_count(),get_host_doctor_defaultDoctor_agents(), get_device_doctor_defaultDoctor_agents(), get_agent_doctor_defaultDoctor_count(),get_host_triage_defaultTriage_agents(), get_device_triage_defaultTriage_agents(), get_agent_triage_defaultTriage_count());
