...
/**
 * nucleate FLAMEGPU Agent Function
 * @param agent Pointer to an agent structure of type xmachine_memory_crystal. This represents a single agent instance and can be modified directly.
...
/**
 * growth FLAMEGPU Agent Function
 * @param agent Pointer to an agent structure of type xmachine_memory_crystal. This represents a single agent instance and can be modified directly.
...
__constant__ float m0;

__constant__ float delta_m0;

__constant__ int nuc_no;

__constant__ int exit_no;

__constant__ int agg_no;
...
extern const float* get_DELTA_T();


extern float h_env_DELTA_T;

/** set_B0
 * Sets the constant variable B0 on the device which can then be used in the agent functions.
 * @param h_B0 value to set the variable
 */
extern void set_B0(float* h_B0);

extern const float* get_B0();


extern float h_env_B0;
...
/** set_b
 * Sets the constant variable b on the device which can then be used in the agent functions.
 * @param h_b value to set the variable
 */
extern void set_b(float* h_b);

extern const float* get_b();


extern float h_env_b;

/** set_y
 * Sets the constant variable y on the device which can then be used in the agent functions.
 * @param h_y value to set the variable
 */
extern void set_y(float* h_y);

extern const float* get_y();


extern float h_env_y;

/** set_t
 * Sets the constant variable t on the device which can then be used in the agent functions.
 * @param h_t value to set the variable
 */
extern void set_t(int* h_t);

extern const int* get_t();


extern int h_env_t;

/** set_m0
 * Sets the constant variable m0 on the device which can then be used in the agent functions.
 * @param h_m0 value to set the variable
 */
extern void set_m0(float* h_m0);

extern const float* get_m0();


extern float h_env_m0;

/** set_delta_m0
 * Sets the constant variable delta_m0 on the device which can then be used in the agent functions.
 * @param h_delta_m0 value to set the variable
 */
extern void set_delta_m0(float* h_delta_m0);

extern const float* get_delta_m0();


extern float h_env_delta_m0;

/** set_nuc_no
 * Sets the constant variable nuc_no on the device which can then be used in the agent functions.
 * @param h_nuc_no value to set the variable
 */
extern void set_nuc_no(int* h_nuc_no);

extern const int* get_nuc_no();


extern int h_env_nuc_no;

/** set_exit_no
 * Sets the constant variable exit_no on the device which can then be used in the agent functions.
 * @param h_exit_no value to set the variable
 */
extern void set_exit_no(int* h_exit_no);

extern const int* get_exit_no();


extern int h_env_exit_no;

/** set_agg_no
 * Sets the constant variable agg_no on the device which can then be used in the agent functions.
 * @param h_agg_no value to set the variable
 */
extern void set_agg_no(int* h_agg_no);

extern const int* get_agg_no();


extern int h_env_agg_no;
